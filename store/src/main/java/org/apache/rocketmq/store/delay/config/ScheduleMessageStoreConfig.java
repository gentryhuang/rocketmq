 ...
 * desc：
 */
public class ScheduleMessageStoreConfig {
    /**
    ...
    /**
     * ScheduleLog 的存储目录，默认为 $user.home/store/schedulelog
     */
    @ImportantField
    ...
    public String getStorePathScheduleLog() {
        return storePathScheduleLog;
    }

    public void setStorePathScheduleLog(String storePathScheduleLog) {
        this.storePathScheduleLog = storePathScheduleLog;
    }
}
