 ...
 * <p>
 * 9 文件清除机制 - {@link ScheduleMessageStore#addScheduleTask()} 使用的是定时任务的方式，在 Broker 启动时会触发 {@link ScheduleMessageStore#start()}
...
public class ScheduleMessageStore {
     ...
     *
     * @see ScheduleMessageStore#findConsumeQueue(String, int)
     * @see ScheduleMessageStore#loadConsumeQueue()
     */
    ...
    public void truncateDirtyLogicFiles(long phyOffset) {
        ConcurrentMap<String, ConcurrentMap<Integer, ConsumeQueue>> tables = ScheduleMessageStore.this.consumeQueueTable;
    ...
    public CompletableFuture<PutMessageResult> asyncPutMessage(MessageExtBrokerInner msg) {
        ...
        putResultFuture.whenComplete((a, b) -> {
            ...
            hashedWheelTimer.newTimeout(timerTask, System.currentTimeMillis() - Long.parseLong(delayTime), TimeUnit.MILLISECONDS);
        });
    ...
    private String getStorePathPhysic() {
        ...
        // 如果启动 Dleger
        if (ScheduleMessageStore.this.getMessageStoreConfig().isEnableDLegerCommitLog()) {
            storePathPhysic = ((DLedgerCommitLog) ScheduleMessageStore.this.getCommitLog()).getdLedgerServer().getdLedgerConfig().getDataStorePath();

            // CommitLog 默认存储路径： /Users/huanglibao/store/commitlog
        } else {
            storePathPhysic = ScheduleMessageStore.this.getMessageStoreConfig().getStorePathCommitLog();
        }
    ...
    private void addScheduleTask() {
        ...
        this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
            ...
            public void run() {
                ...
                ScheduleMessageStore.this.cleanFilesPeriodically();
            }
        ...
        this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
            @Override
            public void run() {
                ScheduleMessageStore.this.checkSelf();
            }
        ...
        this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
            @Override
            public void run() {
                if (ScheduleMessageStore.this.getMessageStoreConfig().isDebugLockEnable()) {
                    try {
                        if (ScheduleMessageStore.this.commitLog.getBeginTimeInLock() != 0) {
                            long lockTime = System.currentTimeMillis() - ScheduleMessageStore.this.commitLog.getBeginTimeInLock();
                            if (lockTime > 1000 && lockTime < 10000000) {

                                String stack = UtilAll.jstack();
                                final String fileName = System.getProperty("user.home") + File.separator + "debug/lock/stack-"
                                        + ScheduleMessageStore.this.commitLog.getBeginTimeInLock() + "-" + lockTime;
        ...
        this.diskCheckScheduledExecutorService.scheduleAtFixedRate(new Runnable() {
            public void run() {
                ScheduleMessageStore.this.cleanCommitLogService.isSpaceFull();
            }
        ...
        public void dispatch(DispatchRequest request) {
            ...
            switch (tranType) {
                ...
                case MessageSysFlag.TRANSACTION_COMMIT_TYPE: // 事务消息 COMMIT
                    ...
                    ScheduleMessageStore.this.putMessagePositionInfo(request);
                    break;
    ...
    class CleanCommitLogService {
        ...
        private void deleteExpiredFiles() {
            ...
            if (timeup || spacefull || manualDelete) {
                ...
                deleteCount = ScheduleMessageStore.this.commitLog.deleteExpiredFile(
                        fileReservedTime,
        ...
        private void redeleteHangedFile() {
            int interval = ScheduleMessageStore.this.getMessageStoreConfig().getRedeleteHangedFileInterval();
            ...
            if ((currentTimestamp - this.lastRedeleteTimestamp) > interval) {
                ...
                int destroyMapedFileIntervalForcibly =
                        ScheduleMessageStore.this.getMessageStoreConfig().getDestroyMapedFileIntervalForcibly();

                // 尝试删除第一个文件
                if (ScheduleMessageStore.this.commitLog.retryDeleteFirstFile(destroyMapedFileIntervalForcibly)) {
                }
            }
        }
    ...
    class CleanConsumeQueueService {
        ...
        private void deleteExpiredFiles() {
            ...
            int deleteLogicsFilesInterval = ScheduleMessageStore.this.getMessageStoreConfig().getDeleteConsumeQueueFilesInterval();

            // 2 获取 CommitLog 最小物理偏移量
            long minOffset = ScheduleMessageStore.this.commitLog.getMinOffset();
            ...
            if (minOffset > this.lastPhysicalMinOffset) {
                ...
                ScheduleMessageStore.this.indexService.deleteExpiredFile(minOffset);
            }
        }
    ...
    class FlushConsumeQueueService extends ServiceThread {
        ...
        private void doFlush(int retryTimes) {
            // 最少刷盘页数
            int flushConsumeQueueLeastPages = ScheduleMessageStore.this.getMessageStoreConfig().getFlushConsumeQueueLeastPages();
            ...
            // 刷盘的间隔时间
            int flushConsumeQueueThoroughInterval = ScheduleMessageStore.this.getMessageStoreConfig().getFlushConsumeQueueThoroughInterval();
            ...
            if (currentTimeMillis >= (this.lastFlushTimestamp + flushConsumeQueueThoroughInterval)) {
                ...
                flushConsumeQueueLeastPages = 0;
                logicsMsgTimestamp = ScheduleMessageStore.this.getStoreCheckpoint().getLogicsMsgTimestamp();
            }
            ...
            if (0 == flushConsumeQueueLeastPages) {
                if (logicsMsgTimestamp > 0) {
                    ScheduleMessageStore.this.getStoreCheckpoint().setLogicsMsgTimestamp(logicsMsgTimestamp);
                }
                ScheduleMessageStore.this.getStoreCheckpoint().flush();
            }
        }
         ...
         */
        public void run() {
            ScheduleMessageStore.log.info(this.getServiceName() + " service started");
            ...
            while (!this.isStopped()) {
                try {
                    ...
                    int interval = ScheduleMessageStore.this.getMessageStoreConfig().getFlushIntervalConsumeQueue();
                    // 等待 interval 时间
            ...
            ScheduleMessageStore.log.info(this.getServiceName() + " service end");
        }
